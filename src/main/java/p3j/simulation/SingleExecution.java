...
public class SingleExecution {
	...
	protected Matrix2D getGenIndepParameter(Parameter parameter) {
		ParameterAssignment parameterAssignment = genIndepParameters.get(parameter
		    .getName());
	...
	NativeParameters setupBasicNativeParameters(int years) {
		NativeParameters nativeParameters = new NativeParameters(years,
		    projection.getMaximumAge());
		nativeParameters.setMortXm(getGenIndepParameter(Parameters.NAT_MORT_X_M));
		nativeParameters.setMortXf(getGenIndepParameter(Parameters.NAT_MORT_X_F));
		nativeParameters
		    .setDeathProbInfant1halfMale(getGenIndepParameter(Parameters.NAT_DEATHPROB_INFANT_1STHALF_M));
		nativeParameters
		    .setDeathProbInfant1halfFemale(getGenIndepParameter(Parameters.NAT_DEATHPROB_INFANT_1STHALF_F));
		nativeParameters
		    .setSurviveProbO100m(getGenIndepParameter(Parameters.NAT_SURV_PROB_O100_M));
		nativeParameters
		    .setSurviveProbO100f(getGenIndepParameter(Parameters.NAT_SURV_PROB_O100_F));
		nativeParameters.setFertX(getGenIndepParameter(Parameters.NAT_FERT));
		nativeParameters
		    .setPEndSYm(getGenIndepParameter(Parameters.NAT_P_END_SY_M));
		nativeParameters
		    .setPEndSYf(getGenIndepParameter(Parameters.NAT_P_END_SY_F));
		nativeParameters
		    .setMaleRateLiveBirth(getGenIndepParameter(Parameters.NAT_PROP_LIVEBIRTH_M));
