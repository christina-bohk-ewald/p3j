 ...
 * 
 */
public class RandomParamAssignmentGenFactory extends ParamAssignmentGenFactory {

  /**
   * Serialization ID.
   */
  private static final long serialVersionUID = 2398583540713702681L;
  ...
  public IParamAssignmentGenerator create(ParameterBlock params) {
    return new RandomParamAssignmentGenerator();
  }
