...
public class TestSetManager extends TestCase {
	...
	protected final ParameterInstance instance1 = new ParameterInstance(0,
	    Parameters.EMIG_MORT_X_F);

	/** The second parameter instance. */
	protected final ParameterInstance instance2 = new ParameterInstance(1,
	...
	private void testMapping(
		...
		assertEquals(assignmentFirstInst, currentMapping.get(instance1));
		assertEquals(assignmentSecondInst, currentMapping.get(instance2));
	}
